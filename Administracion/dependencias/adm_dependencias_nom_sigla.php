...
?>
      ...
      <?php
        ...
        $sqlNomSigla.= " and (translate(upper(dep_sigla),'ÁÉÍÓÚÀÈÌÒÙÄËÏÖÜÑ','AEIOUAEIOUAEIOUN')";        
       ...
       ?>
         <?php 
         if ($sirepite==1){
             echo "<font color='red'>Intente otras Siglas</font>";             
         }
         ?>
          
          <input type="hidden" name="txt_modifica_sigla" id="txt_modifica_sigla" value="<?=$sirepite?>" >
