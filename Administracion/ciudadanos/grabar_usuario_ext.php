 ...
 * Por razones de proceso, dejo tal como esta en la version anterior
 * Autor: David Gamboa
 */
/*************************************************************************************/
$ruta_raiz = "../..";
...
if ($grabar_ciu==1){
    ...
    $ciud->grabar_log_tabla('LOG_USR_CIUDADANOS',$rs_old, $rs_new, $_SESSION['usua_codi'],1);    
}
...
if ($ciu_nuevo==0 and trim($ciu_email)!="") {
    ...
    $usr_email = $ciu_email;
    include "../usuarios/cambiar_password_mail.php";
