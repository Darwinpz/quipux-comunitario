...
<!--                <input type="button" class="button" value="Buscar" id="search" style="" />-->
        ...
        <tr class="listado2"><td align="center" width="50%">
                ...
                <a href="javascript:seleccionar_todo(1)"><font color="blue">Agregar todas las Áreas</font></a>
                &nbsp;&nbsp;
                <a href="javascript:seleccionar_todo(0)"><font color="blue">Eliminar todas las Áreas</font></a>        
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="50%">
                <div id="demo1" class="demo">
                    ...
                    <ul>                        
                        <?php echo obtenerAreas($_SESSION['inst_codi'], $db,$usrCodigo)."<br>";                       
                        ?>
                    </ul>	
