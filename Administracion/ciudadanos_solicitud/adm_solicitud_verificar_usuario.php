...
<?
    if($sol_accion == 1){
      ...
      <center><table width="50%" border="1" class='t_bordeGris'>             
        ...
        <?php } ?>
        <tr>
            <td><span class='listado5'><center><B>¿Desea aprobar la solicitud y crear un nuevo usuario?</B></center></span>
            </td>
        </tr>
        <?php
        if ($rs_existe==1){ ?>  
    ...
    <?php
     }else{//rechazar la solicitud
        ?>
        <center><table width="50%" border="1" class='t_bordeGris'>             
            <tr>
            <td width='100%' colspan="2" class='listado2'>
